...
<head>
    ...
    <title>Daftar Objek Wisata Karimun Jawa</title>
    ...
    <div class="container my-3">
        ...
        <div class="card">
            <div class="card-header">
                <h2><i class="fa-solid fa-circle-plus"></i> Tabel Data Lokasi Objek Wisata Pulau Karimunjawa</h2>
            </div>
            <div class="card-body">
                        ...
                        foreach ($dataobjek as $d) : ?>
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    ...
                                    <a class="btn btn-danger" href="<?= base_url('home/hapus_data/') . $d['id'] ?>" role="button" onclick="return confirm('Yakin akan menghapus data <?= $d['nama'] ?> ini?')"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </body>
