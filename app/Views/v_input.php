            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <?php if (auth()->loggedIn()) : ?>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-circle-plus" style="color: #164569;">
                                </i> Input</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container my-3">
        ...
        <div class="card">
            <div class="card-header">
                <h2><i class="fa-solid fa-circle-plus"></i> Input Data Lokasi Objek Wisata Karimunjawa</h2>
            </div>
            <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fa-solid fa-circle-info" style="color: #164569;"></i> Info</h1>
